...
fn create_event(
   ...
   let input_data = SolEvent::try_from_slice(&instruction_data)
...
//    campaign_data.lamps -= input_data.amount;
...
//    campaign_data.lamps += **donator_program_account.lamports.borrow();
//    campaign_data.serialize(&mut &mut writing_account.data.borrow_mut()[..])?;
